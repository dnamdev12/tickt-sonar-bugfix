...
exports.classNamesToTypeDefinitions = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var lines, _a, ClassNames, _b, Styles, typeDefinition;
            ...
            case 0:
                ...
                switch (options.exportType) {
                    case "default":
                        ...
                        lines.push.apply(lines, options.classNames.map(function (className) {
                    ...
                    case "named":
                        if (options.banner)
                            lines.push(options.banner);
                        lines.push.apply(lines, options.classNames
                            .filter(isValidName)
                            .map(classNameToNamedTypeDefinition));
                        break;
                }
                if (!lines.length) return [3 /*break*/, 2];
                typeDefinition = lines.join("" + os_1.default.EOL) + ("" + os_1.default.EOL);
                return [4 /*yield*/, prettier_1.attemptPrettier(typeDefinition)];
